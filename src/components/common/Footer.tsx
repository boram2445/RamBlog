    ...
    <footer className='mt-12 border-t border-gray-200'>
      <div className='max-w-screen-2xl mx-auto px-4 py-6 '>
        <Link href='/' className='flex items-center gap-2 mb-4'>
          ...
          <h1 className='text-xl font-semibold  text-gray-700'>RAMBLOG</h1>
        </Link>
        <div className='flex justify-between text-gray-600 flex-col laptop:flex-row gap-2 laptop:gap-0'>
